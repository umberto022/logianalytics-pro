...
st.set_page_config(
    page_title="LogiAnalytics Pro - Con Login",
    page_icon="🔐",
    layout="wide",
...
class Database:
    def __init__(self, db_path="logi_analytics.db"):
    ...
    def get_session(self, session_token):
        ...
        cursor.execute('''
            SELECT u.id, u.username, u.email, u.full_name, u.role, u.subscription_plan, u.company_name
            FROM users u
...
def main():
    ...
    <div class="main-header">
        ...
        <p>Plataforma de Análisis Logístico con Sistema de Login</p>
    </div>
    """, unsafe_allow_html=True)
...
def show_login_page(db):
    ...
    with col2:
        ...
        <div style="background: #f8f9fa; padding: 1rem; border-radius: 10px; margin-top: 2rem;">
            ...
            <p><em>O crea una cuenta nueva</em></p>
        </div>
        """, unsafe_allow_html=True)
